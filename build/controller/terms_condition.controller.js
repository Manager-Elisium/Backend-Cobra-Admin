...
const terms_conditions_service_1 = require("./../services/terms_conditions.service");
...
function insert(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        try {
            let data = yield (0, terms_conditions_service_1.createTerm)(req.body);
            if (!data) {
                return res
            ...
            return res.json({ status: true, data: yield encryptedData, message: "terms and conditions create successfully" });
        }
        catch (error) {
...
function list(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        try {
            let data = yield (0, terms_conditions_service_1.findTerm)();
...
function allDataList(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            let data = yield (0, terms_conditions_service_1.findAllTerm)(query);
            const encryptedData = (0, encrypt_1.encrypt)(JSON.stringify(data), secretKey);
            return res.json({ status: true, data: yield encryptedData, message: "Tearms and conditions list" });
        }
        catch (error) {
            return res.json({ status: false, message: (_a = error === null || error === void 0 ? void 0 : error.message) !== null && _a !== void 0 ? _a : "" });
        }
...
function Delete(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield (0, terms_conditions_service_1.deleteTerm)(primaryId);
...
function update(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const { id } = req.params;
            yield (0, terms_conditions_service_1.updateTerm)(id, req.body);
            let updatedTC = yield (0, terms_conditions_service_1.findOneTerm)(id);
            const encryptedData = (0, encrypt_1.encrypt)(JSON.stringify(updatedTC), secretKey);
            return res.json({
...
//# sourceMappingURL=terms_condition.controller.js.map